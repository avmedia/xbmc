...
bool CSettings::InitializeDefinitions()
{
  ...
  if (CFile::Exists(SETTINGS_XML_FOLDER "dsplayer.xml") && !Initialize(SETTINGS_XML_FOLDER "dsplayer.xml"))
	  CLog::Log(LOGFATAL, "Unable to load DSPlayer-specific settings definitions");
#endif
